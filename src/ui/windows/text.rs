...
pub const STRING_MAIN_ABORT: UINT = 6;

pub const STRING_MAIN_COMMITS_COLUMN_MESSAGE: UINT = 7;
pub const STRING_MAIN_COMMITS_COLUMN_HASH: UINT = 10;
pub const STRING_MAIN_COMMITS_COLUMNS: Range<UINT> = STRING_MAIN_COMMITS_COLUMN_MESSAGE..STRING_MAIN_COMMITS_COLUMN_HASH + 1;

pub const STRING_MAIN_PATCHES_COLUMN_MESSAGE: UINT = 11;
pub const STRING_MAIN_PATCHES_COLUMN_DATE: UINT = 13;
pub const STRING_MAIN_PATCHES_COLUMNS: Range<UINT> = STRING_MAIN_PATCHES_COLUMN_MESSAGE..STRING_MAIN_PATCHES_COLUMN_DATE + 1;

pub const STRING_REJECTS_ACCEPT_HUNK: UINT = 14;
pub const STRING_REJECTS_UNACCEPT_HUNK: UINT = 15;
